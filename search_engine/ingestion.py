...
if __name__ == '__main__':
    dataset_dir = '/mnt/cfs_algo_bj/models/experiments/shenyucheng/Info_Doc_VQA'
    ingestion = Ingestion(dataset_dir,input_prefix='img',output_prefix='colqwen_ingestion',embed_model_name='/mnt/cfs_algo_bj/workspace/shenyucheng/vidore_colqwen2-v1.0') # colqwen2
