...
if __name__ == "__main__":
    colpali = VL_Embedding("/mnt/cfs_algo_bj/workspace/shenyucheng/vidore_colqwen2-v1.0")
    image_embeddings = colpali.embed_img("/mnt/cfs_algo_bj/workspace/shenyucheng/vidoseek/img/00a76e3a9a36255616e2dc14a6eb5dde598b321f_1.jpg")
