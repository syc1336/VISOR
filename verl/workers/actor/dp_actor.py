...
class DataParallelPPOActor(BasePPOActor):
    ...
    def _forward_micro_batch(self, micro_batch, temperature) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        if 'multi_modal_inputs' in micro_batch:
            # Collect keys present in ALL samples to avoid KeyError when some
            # samples had their images fully truncated.
            all_keys = [set(inputs.keys()) for inputs in micro_batch['multi_modal_inputs']]
